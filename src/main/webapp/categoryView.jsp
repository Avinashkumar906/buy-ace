...
<body>
	...
	<div class="display-4 text-center col-12 py-2 text-light font-weight-bold"><%=request.getParameter("category")%></div>
		<%
	    ...
	    ListIterator<Product> Iterator = list.listIterator();
		    while(Iterator.hasNext()){
	    		...
	    		out.print("<a href=\"ShoppingCart?id="+product.getProductId()+"\" class=\"btn btn-primary\"> <b>Cart<sup>+</sup> </b> </a> ");
	    		out.print(" <a href=\"viewItem.jsp?id="+product.getProductId()+"\" class=\"btn btn-primary\"> <b> View</b> </a>");
